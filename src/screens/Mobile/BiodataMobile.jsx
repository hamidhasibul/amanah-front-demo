...
import { UpersonalW } from "./updateforms/updatepersonalinfoW";
import { UfamilyW } from "./updateforms/updateamilyW";
import { UeducationW } from "./updateforms/updateeduW";
import { UexpectedbioW } from "./updateforms/updatexpectedbioW";
import { UcontactW } from "./updateforms/updatecontactW";
import { UavaterW } from "./updateforms/updateavatarW";
import { UCommetment } from "./updateforms/updatecommetment";
import { useNavigate } from "react-router-dom";
import { Loader } from "../../components/Loader";
export const BiodataMobile = () => {
                ...
                <div className="row p-lg-4 p-2 my-5 mt-2 font-lal">
                  ...
                  {personalInfo == null ? (
                    ...
                    <>
                      ...
                      avater?.draft == 0 ? (
                        <>
                          <div className="col-12 justify-content-between d-flex align-items-center mb-2">
                            {userinfo.status == 1 && (
                              <>
                                <p className="mb-0 me-2 font-14">
                                  বায়োডাটা স্ট্যাটাস{" "}
                                  <span className="font-12 text-muted">
                                    (সবার জন্য উন্মুক্ত করতে ইচ্ছুক? )
                                  </span>
                                </p>
                          ...
                          {userinfo.status == 0 && (
                            <div className="container">
                              <div class="statusbarp text-center mb-2">
                                <p class="verifyp font-12">
                                  আপনার বায়োডাটাটি ভেরিফিকেশন এর জন্য অপেক্ষমান
                                  রয়েছে
                                </p>
                              </div>
                            </div>
                    ...
                    {personalInfo ? (
                      <>
                        {personalInfo.draft == 1 ? (
                          ...
                          <>
                            <div className="personalinfo mb-3">
                              <div className="member_id_no border">
                                ...
                                <div className="d-flex">
                                  <div className="col-lg-4 col-5 text-secondary font-12 border-bottomc border-end">
                                    <p className="mb-0 font-14 fw-600 font-lal px-3 py-2">
                                      জন্মসাল
                                    </p>
                                  </div>
                                  <div className="col-lg-8 col-7 border-bottomc">
                                    <p className="mb-0 font-14 font-lal px-3 py-2">
                                ...
                                <div className="d-flex">
                                  ...
                                  <div className="col-lg-8 col-7 border-bottomc">
                                    <p className="mb-0 font-14 font-lal px-3 py-2 font-hind">
                                ...
                                <div className="d-flex">
                                  <div className="col-lg-4 col-5 text-secondary font-12 border-end border-bottomc">
                                    <p className="mb-0  font-14 fw-600 font-lal px-3 py-2">
                                      জেলা
                                    </p>
                                  </div>
                                ...
                                <div className="d-flex">
                                  ...
                                  <div className="col-lg-8 col-7">
                                    <p className="mb-0  font-14 font-lal border-bottomc px-3 py-2">
                                ...
                                <div className="d-flex">
                                  <div className="col-lg-4 col-5 text-secondary font-12 border-end">
                                    <p className="mb-0  font-14 fw-600 font-lal px-3 py-2">
                                      নিজের সম্পর্কে
                                    </p>
                                  </div>
                    ...
                    {bioInfo ? (
                      <>
                        {bioInfo.draft == 1 ? (
                          ...
                          <>
                            <div className="expected-bio mb-3">
                              <div className="member_id_no border">
                                <div className="border-bottom bg-bh bio_title d-flex justify-content-between align-items-center">
                                  <p className="font-lal font-20 fw-600 text-c2 mb-0 p-2 px-3">
                    ...
                    {commitmentInfo ? (
                      <>
                        {commitmentInfo.draft == 1 ? (
                          ...
                          <>
                            <div className="commetment-info mb-3">
                              <div className="member_id_no border">
                                <div className="border-bottom bg-bh bio_title d-flex justify-content-between align-items-center">
                                  <p className="font-lal font-20 fw-600 text-c2 mb-0 p-2 px-3">
                                    অঙ্গীকারনামা
                            ...
                            পরিবর্তন করুন{" "} */}
                                ...
                                <div className="d-flex">
                                  <div className="col-lg-8 col-10 text-secondary border-bottomc border-end">
                                    <p className="mb-0 font-14 fw-600 font-lal px-3 py-2">
                                      আল্লহ'র শপথ নিয়ে সাক্ষ্য দিন, বায়োডাটাতে
                                      দেয়া তথ্যগুলো সব সত্য?
                                    </p>
                                  </div>
                                  <div className="col-lg-4 col-2  font-12 border-bottomc">
                                    <p className="mb-0 font-14 font-lal px-3 py-2">
                                ...
                                <div className="d-flex">
                                  <div className="col-lg-8 col-10 text-secondary border-end">
                                    <p className="mb-0 font-14 fw-600 font-lal px-3 py-2">
                                  ...
                                  <div className="col-lg-4 col-2 font-12">
                                    <p className="mb-0 font-14 font-lal px-3 py-2">
